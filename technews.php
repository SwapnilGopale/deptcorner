...
{
       $result = mysqli_query($conn, "select p.id,p.title, p.containt, p.video, p.photo, p.postedon from news p where type='tech' ORDER BY p.postedon desc;");
      ...
      <div class="row content">
        ...
        <div class="col-sm-8 text-center">
         ...
         <div class="row margin_t_b">
                  ...
                  <a  href="delete_post.php?post_id=<?php echo $post_data['id'];?>&uid=<?php echo $uid?>&type=tech"><button type="button" class="btn btn-danger">Delete</button></a><br>
                </div>
                    <?php
                  }
                  else {?>
